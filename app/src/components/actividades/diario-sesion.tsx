...
export function DiarioSesion({
  ...
  return (
    <div className="animar-aparecer max-w-[900px]">
      ...
      <p className="mb-4 max-w-[720px] text-[13.5px] leading-[1.65] text-apagado">
        Un espacio para consignar lo que te deja esta sesión. Tú decides qué se comparte.
      </p>
